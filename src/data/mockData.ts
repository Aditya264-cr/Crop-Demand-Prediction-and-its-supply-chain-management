...
export const PRICE_HISTORY: PriceHistory[] = [
  { day: 'Mon', price: 2100, demand: 70 },
  { day: 'Tue', price: 2120, demand: 75 },
  { day: 'Wed', price: 2110, demand: 82 },
  { day: 'Thu', price: 2150, demand: 85 },
  { day: 'Fri', price: 2180, demand: 88 },
  { day: 'Sat', price: 2200, demand: 90 },
  { day: 'Sun', price: 2250, demand: 95 },
];

export const MARKETS: Market[] = [
  { id: 'm1', name: 'Pimpalgaon Mandi', distance: 12, location: 'Nashik', cropPrices: { 'Wheat': 2250, 'Rice': 4100 }, gain: 120 },
  { id: 'm2', name: 'Nashik APMC', distance: 18, location: 'Nashik', cropPrices: { 'Wheat': 2190, 'Rice': 4250 }, gain: 60 },
  { id: 'm3', name: 'Lasalgaon Market', distance: 42, location: 'Lasalgaon', cropPrices: { 'Wheat': 2100, 'Rice': 4000 }, gain: -30 },
];
